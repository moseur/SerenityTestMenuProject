	...
	public static partial class Texts
	{
		...
		public static class Forms
		{
			public static class Membership
			{
				...
				{
					public static LocalText EmailSubject = "Reset Your TestMenuProject Password";
				...
				{
					public static LocalText ActivateEmailSubject = "Activate Your TestMenuProject Account";
					...
					public static LocalText FormTitle = "Sign up for TestMenuProject";
		...
		public static class Navigation
		{
			...
			public static LocalText SiteTitle = "TestMenuProject";
		}
