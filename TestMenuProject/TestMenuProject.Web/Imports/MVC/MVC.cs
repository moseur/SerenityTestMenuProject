...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Master
        {
            ...
            {
                public const string CountryIndex = "~/Modules/Master/Country/CountryIndex.cshtml";
            }

            public static class Employee
            {
                public const string EmployeeDetailsReport = "~/Modules/Master/Employee/EmployeeDetailsReport.cshtml";
                public const string EmployeeIndex = "~/Modules/Master/Employee/EmployeeIndex.cshtml";
            }
